...
- ~~`src/tools/skill/skill_complete_tool.py` — 适配 MemoryManager 接口~~（**已废弃**：skill_complete 工具已删除，详见 [skill-complete-removal-design.md](../system/skill-complete-removal-design.md)）
