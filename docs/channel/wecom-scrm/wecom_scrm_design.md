...
企业微信 SCRM（Social Customer Relationship Management）场景：
...
在现有渠道配置页面中新增"企业微信 SCRM"渠道类型，配置表单：
...
| `frontend/src/components/ChannelConfig.vue` | 新增 SCRM 渠道配置表单 |
