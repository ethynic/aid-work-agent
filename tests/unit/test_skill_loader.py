...
class TestSkillLoaderToolMapping(unittest.TestCase):
    """工具映射引导（Phase 7 变更）"""
    ...
    def test_get_skill_content_includes_tool_mapping(self):
        """get_skill_content 返回的 system prompt 包含工具映射段"""
        content = """---
name: test-skill
description: 测试技能
---
...
"""
        ...
        result = loader.get_skill_content("test-skill")
        assert result is not None
        assert "**工具映射：**" in result

    def test_tool_mapping_includes_source_file_path(self):
        """工具映射包含 source_file_path 复制说明"""
        content = """---
name: test-skill
description: 测试技能
---
...
"""
    ...
    def test_tool_mapping_includes_replace_section(self):
        """工具映射包含 replace_section 说明"""
        content = """---
name: test-skill
description: 测试技能
---
...
"""
    ...
    def test_tool_mapping_includes_file_read(self):
        """工具映射包含 file_read 说明"""
        content = """---
name: test-skill
description: 测试技能
...
"""
    ...
    def test_tool_mapping_includes_template_instruction(self):
        """工具映射包含模板文件使用说明"""
        content = """---
name: test-skill
description: 测试技能
