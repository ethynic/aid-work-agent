...
| qwen3.8-max-0902 > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 非思考和思考模式 | 0<Token≤1M | 12元 | 36元 | 100万Token |
| qwen3.7-max > 当前能力等同于qwen3.7-max-2026-05-20 > [Batch调用](/zh/model-studio/batch-interfaces-compatible-with-openai)半价 > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 非思考和思考模式 | 0<Token≤1M | 12元 | 36元 | 100万Token |
...
| qwen3.8-max-0902 > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 全球  | 非思考和思考模式 | 0<Token≤1M | 12元 | 36元 |
| qwen3.7-max > 当前能力等同于qwen3.7-max-2026-05-20 > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 全球  | 非思考和思考模式 | 0<Token≤1M | 12元 | 36元 |
| qwen3.7-max-us > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 美国  | 非思考和思考模式 | 0<Token≤1M | 18.736元 | 56.207元 |
...
| qwen3.8-max-0902 > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 国际  | 非思考和思考模式 | 0<Token≤1M | 14.988元 | 44.965元 |
| qwen3.7-max > 当前能力等同于qwen3.7-max-2026-05-20 > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 国际  | 非思考和思考模式 | 0<Token≤1M | 18.736元 | 56.207元 |
...
| deepseek-v4-pro-us > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 美国  | 17.986元 | 35.972元 |
...
| deepseek-v4-flash-us > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 美国  | 1.499元 | 2.998元 |
| deepseek-v4-flash-0731-us > [上下文缓存](/zh/model-studio/context-cache)享有折扣 | 美国  | 忙时 3.208元 闲时 1.604元 | 忙时 9.625元 闲时 4.813元 |
...
| glm-5.2-us | 美国  | 非思考和思考模式 | 不区分阶梯 | 10.492元 | 32.974元 |
...
| ZHIPU/GLM-5.3-Flash | 仅思考模式 | 原价0.8元**（限时5折）** | 原价2.8元**（限时5折）** | 无   |
...
| --- | --- | --- | --- |
| happyhorse-1.1-t2v | 480P | 0.45元/秒 | 10秒 |
| 720P | 0.9元/秒 |
| 1080P | 1.2元/秒 |
...
| --- | --- | --- | --- |
| happyhorse-1.1-t2v | 全球  | 480P | 0.45元/秒 |
| 720P | 0.9元/秒 |
| 1080P | 1.2元/秒 |
...
| **模型 ID（Model ID）** | **服务部署范围** | **输出视频分辨率** | **输出单价** |
| --- | --- | --- | --- |
| happyhorse-1.1-t2v | 国际  | 480P | 0.524594元/秒 |
| 720P | 1.049188元/秒 |
| 1080P | 1.348956元/秒 |
...
| **模型 ID（Model ID）** | **输出视频分辨率** | **输出单价** | **免费额度**[（注）](/zh/model-studio/new-free-quota#977b13081ab56) 有效期：自开通百炼/模型发布/申请通过之日起90天内（以较晚者为准） |
| --- | --- | --- | --- |
| happyhorse-1.1-i2v | 480P | 0.45元/秒 | 10秒 |
| 720P | 0.9元/秒 |
| 1080P | 1.2元/秒 |
...
| **模型 ID（Model ID）** | **服务部署范围** | **输出视频分辨率** | **输出单价** |
| --- | --- | --- | --- |
| happyhorse-1.1-i2v | 全球  | 480P | 0.45元/秒 |
| 720P | 0.9元/秒 |
| 1080P | 1.2元/秒 |
...
| **模型 ID（Model ID）** | **服务部署范围** | **输出视频分辨率** | **输出单价** |
| --- | --- | --- | --- |
| happyhorse-1.1-i2v | 国际  | 480P | 0.524594元/秒 |
| 720P | 1.049188元/秒 |
| 1080P | 1.348956元/秒 |
...
| **模型 ID（Model ID）** | **输出视频分辨率** | **输出单价** | **免费额度**[（注）](/zh/model-studio/new-free-quota#977b13081ab56) 有效期：自开通百炼/模型发布/申请通过之日起90天内（以较晚者为准） |
| --- | --- | --- | --- |
| happyhorse-1.1-r2v | 480P | 0.45元/秒 | 10秒 |
| 720P | 0.9元/秒 |
| 1080P | 1.2元/秒 |
...
| **模型 ID（Model ID）** | **服务部署范围** | **输出视频分辨率** | **输出单价** |
| --- | --- | --- | --- |
| happyhorse-1.1-r2v | 全球  | 480P | 0.45元/秒 |
| 720P | 0.9元/秒 |
| 1080P | 1.2元/秒 |
...
| **模型 ID（Model ID）** | **服务部署范围** | **输出视频分辨率** | **输出单价** |
| --- | --- | --- | --- |
| happyhorse-1.1-r2v | 国际  | 480P | 0.524594元/秒 |
| 720P | 1.049188元/秒 |
| 1080P | 1.348956元/秒 |
...
| --- | --- | --- |
| qwen3.7-text-embedding > [Batch调用](/zh/model-studio/batch-interfaces-compatible-with-openai)半价 | 0.5元 | 100万Token |
| qwen3.7-text-embedding-flash > [Batch调用](/zh/model-studio/batch-interfaces-compatible-with-openai)半价 | 0.125元 | 100万Token |
...
| **模型 ID（Model ID）** | **输入单价（每百万Token）** | **免费额度**[（注）](/zh/model-studio/new-free-quota#977b13081ab56) 有效期：自开通百炼/模型发布/申请通过之日起90天内（以较晚者为准） |
| --- | --- | --- |
| qwen3.7-text-rerank | 文本输入：0.5元 | 100万Token |
...
| qwen-flash-character | 全球  | 0.25元 | 1.5元 |
