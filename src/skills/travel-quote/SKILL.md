...
4. **不复述报价单已体现的明细，只汇总总价**：人群票种（成人/学生/儿童/老人）、含早、房型、间数等细节**已经在 Excel 报价单的"项目"和"备注"列里**，文字总结**禁止**自行复述、解读或拆解这些细节。具体禁止：
    - ❌ 禁止说"含儿童票""含老人票""学生票""儿童半票/免票""含双早""大床房"等任何**票种/含早/房型构成**措辞
    - ❌ 禁止把景点门票拆成"成人票 X + 儿童票 Y"等子项说明
    - ✅ 景点门票只能用一句总价汇总（例如"景点门票合计约 6.3 万"），**不要**解释这张票怎么构成
    - 原因：这些字段由后端规则计算，LLM 凭直觉复述极易与报价单实际内容不一致；客户要看明细请让其查阅 Excel。**只总结**：总人数、行程天数、人均报价、总价、合计_随队老师、出发/目的地、行程亮点
