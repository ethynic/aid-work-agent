...
const ICON_RULES: Array<{ keywords: string[]; path: string }> = [
  { keywords: ['会话任务'], path: 'M21 11a8 8 0 01-8 8H7l-4 3v-7a8 8 0 118-12h2a8 8 0 018 8zM8 9h8M8 13h5' },
  // 微信营销（运行详情在自动化之前，避免被通用词抢占）
  { keywords: ['运行详情', '运行记录'], path: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2M12 11v6M9 14h6' },
  { keywords: ['微信营销', '微信自动化', '群绑定'], path: 'M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z' },
