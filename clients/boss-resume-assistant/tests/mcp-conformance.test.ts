...
test('mcp-conformance 套件 CLI 模式可独立运行', async () => {
  ...
  execFileSync(
    ...
    [
      ...
      '--expect-tools',
      'boss_filter,boss_clear_filter,boss_goto,boss_greet,boss_accept_resume,boss_reject_current,boss_interview_demo,boss_send_to,boss_send_current,boss_read_chat,boss_open_chat,boss_list_jobs,boss_select_job,boss_filter_options,boss_resume_detail,boss_resume_batch',
      '--call',
